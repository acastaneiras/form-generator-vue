<template>
    <div ref="questionData">
        <div class="mb-6">
            <h2 class="flex w-full align-middle justify-center text-gray-500 dark:text-gray-400 "><i class="fa-solid fa-square-check fa-2x"></i>
                <div class="text-lg font-semibold ml-1"> Checkbox</div>
            </h2>
        </div>
        <div class="mb-6">
        ...
        <div class="mb-6">
            ...
            <label for="hasPunctuation" class="inline-flex relative items-center cursor-pointer">
                <input v-model="store.question.hasPunctuation" type="checkbox" value="" id="hasPunctuation"
                    class="sr-only peer">
                <div
        ...
        <div class="mb-6">
            ...
            <div v-for="(option, index) in store.question.options" class="flex w-100 pb-2" :key="index">
                ...
                <button @click="removeOption(index)"
                    class="btn-app w-auto hover:text-red-700 dark:hover:text-red-700 ml-1 aspect-square ms-2"
                    type="button">
