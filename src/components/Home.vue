<template>
  <n-config-provider :theme="darkMode ? darkTheme : null" :theme-overrides="darkMode === false ? lightThemeOverrides : darkThemeOverrides">
...
const lightThemeOverrides = {
  common: {
    primaryColor: '#8C8C8CFF',
    primaryColorHover: '#8C8C8CFF'
  }
}
